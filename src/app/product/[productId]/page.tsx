...
const page = async ({ params }: PageProps) => {
    ...
    return (
        <MaxWidthWrapper className='bg-white'>
                        ...
                        <div className="">
                            ...
                            <div className="mt-6 text-center">
                                <div className="group inline-flex text-sm text-medium ">
                                    ...
                                    <span className=" text-muted-foreground hover:text-gray-700 first-line:"> 30 Day return garay</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <ProductReel href="/product" query={{ category: product.category, limit: 4 }} title={`Similer ${label}`} subtitle={`Browser similer high-quality ${label} just like ${product.name}`} />
